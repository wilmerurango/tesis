...
class HierarBehavioralModel(BaseModel):
    ...
    def clean_data(self):
        ...
        # self.demanda.to_excel('/home/wilmer/Documentos/Codes/tesis/Instancias/test/test1/demanda_comp.xlsx', index=False)
...
# FUNÇÕES ADICIONAIS
def save_solution(model, BX, BL, BD, P, d, X, Y, A, BY, perio, nameModel, indexCombiDem, path):
