...
\begin{flushleft}
	\begin{minipage}[c]{.5\textwidth}
		...
		\textbf{Co-orientador: Dr(a). Karim Perez Martínez} \\ \vspace*{1cm} \\
		Este exemplar corresponde à versão final da dissertação defendida pelo aluno Wilmer Darío Urango Narváez, e orientado pelo Prof. Diego Jacinto Fiorotto.
	\end{minipage}
\end{flushleft}
\vspace*{0.5cm}
