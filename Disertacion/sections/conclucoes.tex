...
Os modelos propostos possuem uma característica importante, a unimodularidade, onde 10 dos 16 modelos são totalmente unimodulares para as 10 instâncias, o que contribui para os baixos tempos de execução mencionados. Para os modelos que não são totalmente unimodulares, o valor de delta é pequeno em comparação ao total de restrições do problema, o que também contribui para uma resolução eficiente usando a definição de delta-modular. Esse aspecto explica de forma concisa os baixos tempos de solução e o número reduzido de nós explorados durante o processo de resolução.
...
Adicionalmente, seria interessante explorar o problema sob a ótica da inteligência artificial, utilizando, por exemplo, aprendizado profundo (deep learning), seja para gerenciar a demanda ou para resolver o problema em si. Nos últimos anos, diversas propostas surgiram, mas esse é um campo ainda pouco explorado, o que o torna uma área promissora a ser investigada.
