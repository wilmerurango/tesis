...
\vspace{-1.0cm}
\begin{quotation}
	Esta dissertação aborda o problema da gestão de receitas no transporte ferroviário de passageiros, onde a capacidade de assentos é perecível e a demanda apresenta substituição entre tarifas e variação temporal. O problema central consiste em decidir, para cada origem-destino, o tipo de assento e período de reserva, quantos assentos de cada classe devem ser protegidos (reservas) e quantos devem ser liberados para venda (autorizações) em um trem de passageiros, considerando que os clientes podem escolher dentro de um conjunto de tarifas, que os assentos não vendidos se perdem e que a empresa pode impor restrições operacionais, como \textit{fulfillment over periods} ou \textit{skip-lagging}.
